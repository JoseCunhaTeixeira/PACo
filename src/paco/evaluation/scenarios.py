...
SCENARIOS = (
    ...
    Scenario(
        ...
        checks=(
            called("run_processing", profile="active_p1", overrides=SMALL_WINDOWS),
    ...
    Scenario(
        ...
        checks=(
            called("run_processing", profile="passive_p1", overrides=SMALL_WINDOWS),
    ...
    Scenario(
        ...
        checks=(called("run_processing"), answer_mentions("96")),
    ...
    Scenario(
        ...
        checks=(called("invert"), asked_the_user(), no_inversion_started()),
